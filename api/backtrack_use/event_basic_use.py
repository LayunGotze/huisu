...
def event_all_conclusion(data):
    #将4类数据的结果整合为总结果
    ret = {'time': [], 'legend': ['事件热度'], 'data': []}
    ret['time']=data['time']
    tmp_dict = {'name': '事件热度', 'type': 'line', 'smooth': 'true', 'data': []}
    tmp_dict['data']=[0]*len(ret['time'])
    for item in data['data']:
        tmp=[item['data'][i]+tmp_dict['data'][i] for i in range(len(ret['time']))]
        tmp_dict['data']=tmp
    ret['data'].append(tmp_dict)
    return ret
...
17: {'time': ['20180401', '20180402', '20180403', '20180404', '20180405', '20180406', '20180407', '20180408', '20180409', '20180410'], 'legend': ['事件热度'], 'data': [{'name': ['事件热度'], 'type': 'line', 'smooth': 'true', 'data': [4, 37, 71, 74, 51, 61, 0,0, 0, 0]}]}}
data=event_all_4_conclusion(origin)
print(data)
print(event_all_conclusion(data))